  ...
  const deleteTask = async (taskId) => {
    try {
      ...
      if (ethereum) {
        ...
        // Supprimez la tâche avec l'ID taskId
        await TaskContract.deleteTask(taskId);
  
        // Mettez à jour la liste des tâches après la suppression
...
{currentAccount === '' ? (
  ...
  Connect Wallet
    ...
    <div className="App">
      <h2>MUGLomeGabon Task Management App</h2>
      <form>
